...
{
    public class CheatingSpouseModel : PageModel
    {
        ...
        public CheatingSpouseModel(DilemmaService dilemmaService)
        {
...
await _dilemmaService.RecordResponseAsync(userId, 4, choice, 0, userName); // Pass name to service
