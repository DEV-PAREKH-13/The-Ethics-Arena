...
{
    public class FalseWitnessModel : PageModel
    {
        ...
        public FalseWitnessModel(DilemmaService dilemmaService)
        {
        ...
        public void OnGet()
        {
            Dilemma = _dilemmaService.GetDilemmaById(9);
            Navigation = _dilemmaService.GetNavigationForDilemma(9);
        }
...
await _dilemmaService.RecordResponseAsync(userId, 9, choice, 0, userName); // Pass name to service
            
            // Get stats from MongoDB
            var stats = await _dilemmaService.GetResponseStatsAsync(9);
