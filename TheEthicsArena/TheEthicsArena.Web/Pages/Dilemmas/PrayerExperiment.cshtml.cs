...
{
    public class PrayerExperimentModel : PageModel
    {
        ...
        public PrayerExperimentModel(DilemmaService dilemmaService)
        {
        ...
        public void OnGet()
        {
            Dilemma = _dilemmaService.GetDilemmaById(10);
            Navigation = _dilemmaService.GetNavigationForDilemma(10);
        }
...
await _dilemmaService.RecordResponseAsync(userId, 10, choice, 0, userName);            
            // Get stats from MongoDB
            var stats = await _dilemmaService.GetResponseStatsAsync(10);
